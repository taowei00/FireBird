 ...
 * on 2020/1/4
 */
public class MvpEmptyViewProccessor {
    String CLASS_NAME = "MvpEmptyViewFactory";

    public void proccess(RoundEnvironment roundEnv, MvpProccessor processor) {
        try {
            ...
            JavaFile javaFile = JavaFile.builder("crazy.information.mvp", tb.build()).build();
